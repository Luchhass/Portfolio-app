...
export default function ContactPage() {
  return (
    <main className="flex flex-col gap-18 lg:min-h-[calc(100vh-104px)] lg:flex-row lg:items-center lg:justify-between mt-[88px] md:mt-[104px] px-8 py-6 md:px-10 md:py-8 lg:px-16 lg:py-8">
      <div>
        <h1 className="text-black dark:text-white font-extrabold text-7xl md:text-8xl lg:text-9xl leading-14 md:leading-20 lg:leading-26 tracking-[-0.07em] pb-8 max-w-[450px] lg:min-w-[420px]">
          get in
          <br />
