    ...
    <section className="flex items-center justify-center pb-24 md:pb-36 lg:pb-48">
      <div className="flex flex-col items-center gap-6 md:gap-8 lg:gap-10">
        <div className="cta-item relative mx-auto w-fit">
          <h1 className="relative z-3 whitespace-nowrap text-center text-7xl font-black lowercase leading-[0.8] tracking-[-0.02em] text-black dark:text-white md:text-8xl lg:text-9xl">
          ...
          <h1
            className="absolute -top-[1.5px] -left-[1px] z-2 whitespace-nowrap text-center text-7xl font-black lowercase leading-[0.8] tracking-[-0.02em] md:text-8xl lg:text-9xl"
            style={{
              WebkitTextStroke: "1.5px #f37a35",
              color: "transparent",
            }}
          >
            <AnimatedSection animation="contact-cta-animations">
          ...
          <h1
            className="absolute -top-[4px] -left-[1px] z-1 whitespace-nowrap text-center text-7xl font-black lowercase leading-[0.8] tracking-[-0.02em] md:text-8xl lg:text-9xl"
            style={{
              WebkitTextStroke: "1.5px #8a8a8a",
              color: "transparent",
            }}
          >
            <AnimatedSection animation="contact-cta-animations">
        ...
        <AnimatedSection animation="contact-cta-animations" as="div">
