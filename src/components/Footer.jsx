    ...
    <footer className="bg-[#f37a35] h-[calc(100vh-88px)] md:h-[calc(100vh-104px)] flex flex-col justify-between relative overflow-hidden px-8 py-6 md:px-10 md:py-8 lg:px-16 lg:py-8">
      ...
      <div className="lg:hidden flex flex-col justify-between h-full">
        ...
        <nav aria-label="Footer navigation">
          <ul className="flex flex-col gap-1 text-white font-extrabold uppercase text-2xl md:text-3xl font-sans leading-[1.2] md:leading-[1.4] tracking-[-0.05em]">
      ...
      <div className="hidden lg:flex flex-col h-full">
        ...
        <div className="flex justify-between items-center flex-1">
          <div className="flex-1">
            <h1 className="text-white max-w-2xl lg:max-w-[680px] font-extrabold uppercase text-7xl font-sans lg:leading-[0.9] tracking-[-0.05em]">
              designing with purpose and passion.
            </h1>
          </div>
