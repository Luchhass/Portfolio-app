...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#f37a35] relative flex flex-col justify-between overflow-hidden px-8 py-6 h-[calc(100svh-90px)] md:h-[calc(100svh-106px)] md:px-10 md:py-8 lg:px-16 lg:py-8">
